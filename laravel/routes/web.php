...
Route::middleware('prevent-back-history')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/user/approve/buissness/{id}', 'UserController@aproveUnaprove')->name('user.approve');
        ...
        Route::get('user/document/view/{id}', 'UserController@documentView')->name('user.documentView');
